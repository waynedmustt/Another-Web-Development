...
class Kategori extends CI_Controller {
	...
	function barang($id){ 
		$total_rows = $this->m_kategori->count_all_type($id);
		...
		$data['kategori'] = $this->m_kategori->get_category($id,$mulai_dari,$limit);	
		$data['jenis_barang'] = $this->m_kategori->get_jenis_barang();
