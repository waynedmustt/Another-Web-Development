...
<head>
    ...
    <title>Produk | Dmustt Online Shop</title>
				...
				<div class="row">
					...
					<div class="col-sm-3">
						<div class="search_box pull-right">
							...
							<input type="text" name="barang_cari" placeholder="Cari Produk"/>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-sm-9 padding-right">
								...
								<div class="single-products">
										...
										<div class="product-overlay">
											<div class="overlay-content">
												...
												<a href="<?php echo base_url()."index.php/detail/".$row->ID_BARANG; ?>" class="btn btn-default add-to-cart">
					...
					<?php	
					 if($halaman != $i){  ?>
					  <li><a href="<?php echo base_url() . "index.php/cari"?>?page=<?php echo $i?>&nama=<?php echo $yang_dicari?>&status=1"><?php echo $i?></a></li> 
					 <?php }else{  ?>
					  <li><a href="<?php echo base_url() . "index.php/cari"?>?page=<?php echo $i?>&nama=<?php echo $yang_dicari?>&status=1" class="active"><?php echo $i?></a></li> 
					 <?php
					 } ?>
					 <?php
					} ?>
