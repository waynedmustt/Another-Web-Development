				...
				<div class="row">
					...
					<div class="col-sm-3">
						<div class="search_box pull-right">
							<form method="post" action="<?php echo base_url() . "index.php/cari"?>">
							<input type="text" name="barang_cari" placeholder="Search"/>
					...
					<div id="slider-carousel" class="carousel slide" data-ride="carousel">
						...
						<div class="carousel-inner">
							<div class="item active">
								<div class="col-sm-6">
									<h1><span>DMUSTT</span> ONLINE SHOP</h1>
									<h2>Selamat Datang!</h2>
									<p>Dmustt Online Shop merupakan tempat belanja online yang menyediakan produk - produk dari impor dengan kualitas yang terjamin. 
									"SERVICE NO.1" merupakan moto kami untuk selalu menjadi yang terbaik dalam pelayanan terhadap customer. 
									Klik dibawah ini untuk melihat produk - produk kami</p>
									<a href="<?php echo base_url()."index.php/produk" ?>">
							        <button type="submit" name="update" class="btn btn-default update">Lihat Produk</button></a>
								</div>
								<div class="col-sm-6">
									<img src="<?php echo base_url()?>images/shop/1.jpg" class="girl img-responsive" alt="" />
								</div>
							</div>
							<div class="item">
								<div class="col-sm-6">
									...
									<p>Kami menyediakan beberapa opsi untuk melakukan pembelian. Temukan cara pembelian di Dmustt Online Shop</p>
									<a href="<?php echo base_url()."index.php/pembelian" ?>">
							        <button type="submit" name="update" class="btn btn-default update">Cara Pembelian</button></a>
								</div>
								<div class="col-sm-6">
									<img src="<?php echo base_url()?>images/shop/2.jpg" class="girl img-responsive" alt="" />
								</div>
							</div>
							...
							<div class="item">
								<div class="col-sm-6">
									<h1><span>DMUSTT</span> ONLINE SHOP</h1>
									<h2>Kontak kami</h2>
									<p>Ada hal yang masih belum jelas dan ingin ditanyakan? Kami dengan senang hati menerima bentuk pertanyaan maupun saran agar 
									pelayanan kami kepada customer semakin baik.</p>
									<a href="<?php echo base_url()."index.php/contact" ?>">
							        <button type="submit" name="update" class="btn btn-default update">Hubungi Kami</button></a>
								</div>
								<div class="col-sm-6">
									<img src="<?php echo base_url()?>images/shop/3.jpg" class="girl img-responsive" alt="" />
								</div>
							</div>
