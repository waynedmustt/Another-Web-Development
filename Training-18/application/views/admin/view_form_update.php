		...
		<div id="main">
			...
			<div id="content">
				...
				<!-- Box Head -->
					...
					<form method="post" action="<?php echo base_url() . "index.php/c_barang/update/".$barang;?>" enctype="multipart/form-data">
						<!-- Form -->
						<div class="form">
								<p>
									<label>ID BARANG </label>
									<br>
									<input type="text" name="id_barang" class="field size1" value="<?php echo $barang; ?>" disabled />
								</p>
								<p>
									<label>NAMA BARANG</label>
									<br>
									<input type="text" name="nama_barang" placeholder="Nama Barang" class="field size1" />
								</p>
								<p>
									<label>GAMBAR</label>
									<br>
									<input type="file" name="gambar_update" class="field size1" />
								...
								<p>
									<label>HARGA</label>
									<br>
									<input type="text" name="harga" placeholder="Harga" class="field size1" />
								</p>
								<p>
								...
								<p>
									<label>STOK</label>
									<br>
									<input type="text" name="stok" placeholder="Stok" class="field size1" />
