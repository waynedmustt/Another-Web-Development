		...
		<div class="container">
			<div class="row">
				...
				<div class="col-sm-9 padding-right">
					...
					<?php	
					 if($halaman != $i){  ?>
					  <li><a href="<?php echo base_url() . "index.php/produk"?>?page=<?php echo $i?>"><?php echo $i?></a></li> 
					 <?php }else{  ?>
					  <li><a href="<?php echo base_url() . "index.php/produk"?>?page=<?php echo $i?>" class="active"><?php echo $i?></a></li> 
					 <?php
					 } ?>
					 <?php
					} ?>
